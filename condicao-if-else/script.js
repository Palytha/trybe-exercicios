/*
    ...
    Altere o valor da nota para verificar se as condições que você implementou fun
    cionam;

*/ 

const nota = 81;
let aprovada = 'Aprovada';
let reprovada = 'Reprovada';
let listaDeEspera = 'Lista de Espera';
...
if (nota >= 80) {
    ...
    console.log(`Infelismente você foi reprovada`);
}